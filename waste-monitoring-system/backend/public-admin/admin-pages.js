...
function setupTripTicketManagement() {
  ...
  form.addEventListener("submit", async (event) => {
    ...
    const body = {
      ...
      plateNo: String(document.getElementById("tripTicketPlateNo")?.value || "").trim(),
      bodyNo: String(document.getElementById("tripTicketBodyNo")?.value || "").trim(),
      truckType: String(document.getElementById("tripTicketTruckType")?.value || "").trim(),
      totalDistanceKm: String(document.getElementById("tripTicketTotalDistanceKm")?.value || "").trim(),
      driverName: String(document.getElementById("tripTicketDriverName")?.value || "").trim(),
      garbageCollectors: String(document.getElementById("tripTicketGarbageCollectors")?.value || "").trim(),
      barangay: String(document.getElementById("tripTicketBarangay")?.value || "").trim(),
      routeArea: String(document.getElementById("tripTicketRouteArea")?.value || "").trim(),
      ...
      collectionHoursFrom: String(document.getElementById("tripTicketCollectionHoursFrom")?.value || "").trim(),
      collectionHoursTo: String(document.getElementById("tripTicketCollectionHoursTo")?.value || "").trim(),
      timeDispatched: String(document.getElementById("tripTicketTimeDispatched")?.value || "").trim(),
      ...
      disposalFacility: String(document.getElementById("tripTicketDisposalFacility")?.value || "").trim(),
      contractorDispatcher: String(document.getElementById("tripTicketContractorDispatcher")?.value || "").trim(),
      guide: String(document.getElementById("tripTicketGuide")?.value || "").trim(),
      mmdaUseOnly: String(document.getElementById("tripTicketMmdaUseOnly")?.value || "").trim(),
